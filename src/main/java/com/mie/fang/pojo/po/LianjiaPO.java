...
public class LianjiaPO {
	...
	public LianjiaPO(String anjukeid, String name, String area, String address, String roomcount, String size, BigDecimal price) {
		this.anjukeid = anjukeid;
		this.name = name;
		this.area = area;
		this.address = address;
